import BWP from "../../images/Hotels/BestWestern.webp"
    ...
    <div className="wrapper">
      ...
      <div id="images">
        <a href="https://www.bestwestern.com/en_US/book/hotels-in-isanti/best-western-plus-isanti/propertyCode.24145.html" target="_blank" rel="noreferrer"><img src={BWP} alt="BestWesternPlus" /></a>
          ...
          <p> A block of rooms has been reserved at the AmericInn in North Branch. <br></br> To reserve please call them directly and reference the Oelke / Koppendrayer wedding.</p>
      </div>
    </div>
  )
}
